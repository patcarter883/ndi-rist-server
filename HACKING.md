...
hidden if the `ndi-rist-server_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ndi-rist-server_DEVELOPER_MODE` to the configure
...
Runs the executable target `ndi-rist-server_exe`.
